...
namespace trabajo_integrador
{
	class Program
	{
			...
			while(opcion != 0)
			{
				...
				if(opcion==2)
				{
					...
					while(opcion!=0)
					{
						if(opcion==1)
						{
							Console.WriteLine("¿Desea contratar un evento? (s/n)");
							try
							{
								decision=char.Parse(Console.ReadLine());
								if(decision != 's' && decision != 'n')
							...
							while(decision == 's')
							{
								...
								string diaMesAño = Console.ReadLine();
								string []partes = diaMesAño.Split(new char[]{'/'});
								int dia, mes, año;
								try 
								{
									dia= int.Parse(partes[0]);
									mes = int.Parse(partes[1]);
									año = int.Parse(partes[2]);
								}
								catch(FormatException)
								{
								...
								DateTime fechayHora = new DateTime(dia,mes,año,hora,minutos,segundos);
						...
						{
							Console.WriteLine("¿Desea eliminar servicios de un evento? (s/n)");
							try
							{
								decision = char.Parse(Console.ReadLine());
								if(decision != 's' && decision != 'n')
				...
				else if(opcion == 3)
				{
					...
					while(opcion != 0)
					{
						...
						{
							Console.WriteLine("¿Ver listado de clientes? (s/n)");
							try
							{
								decision = char.Parse(Console.ReadLine());
								if(decision != 's' && decision != 'n')
						...
						{
							Console.WriteLine("¿Ver listado de empleados? (s/n)");
							try
							{
								decision = char.Parse(Console.ReadLine());
								if(decision != 's' && decision != 'n')
		...
		public static void MenuPrincipal()
		{
			...
			Console.WriteLine("---------------------------------------------------------------");
			Console.WriteLine("1) Menú Administrativo");
			Console.WriteLine("2) Menú Eventos");
